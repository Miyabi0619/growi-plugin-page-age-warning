const s="growi-plugin-page-age-warning";const l={dateField:"createdAt",firstThresholdDays:365,secondThresholdDays:730};let m,t=0,u=!1,a,i;function v(e){return/^\/(_api|admin|login|logout|me|trash|in-app-notification|installer)(\/|$)/.test(e)}function w(){document.querySelectorAll(".growi-page-age-warning").forEach(e=>e.remove())}function R(){if(document.getElementById("growi-page-age-warning-style")!=null)return;const e=document.createElement("style");e.id="growi-page-age-warning-style",e.textContent=`
